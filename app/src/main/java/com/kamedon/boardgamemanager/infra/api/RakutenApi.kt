...
interface RakutenApi {
    ...
    fun search(@Query("keyword") keyword: String, @Query("applicationId") applicationId: String = BuildConfig.RAKUTEN_API_KEY, @Query("format") format: String = "json"): Observable<RakutenResponse>
}
